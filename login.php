            ...
            <div class="col-6">
              <form action="./log-in.php" method="get">
                <div class="form-group input-group mt-5">
                  ...
                  <input type="text" class="form-control log" placeholder="Ingrese un nombre de usuario" name="usuario">
                </div>
                <div class="form-gruop input-group">
                  <span class="input-group-text">
                    <i class="fa fa-lock"></i>
                  </span>
                  <input type="password" class="form-control log" placeholder="Minimo 8 caracteres" name="password">
                </div>
                <div class="d-grid">
